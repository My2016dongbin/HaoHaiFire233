...
public class FireMapActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        longitude_double = intent_g.getDoubleExtra("longitude_double", AddFireActivity.LONGTITUDE_DEF);
        latitude_double = intent_g.getDoubleExtra("latitude_double", AddFireActivity.LATITUDE_DEF);
        if (longitude_double == AddFireActivity.LONGTITUDE_DEF && latitude_double == AddFireActivity.LATITUDE_DEF) {
        ...
        switch (view.getId()) {
            case R.id.tv_map:
                if (null == longitude || null == latitude) {
                    Toast.makeText(FireMapActivity.this, "请在地图上选择您的门店位置", Toast.LENGTH_SHORT).show();
                } else {
                    if (city == "" || city == null){
                        ...
                        FireMapActivity.this.setResult(AddFireActivity.MAP_REUEST_CODE, intent);
                        finish();
                    }
