...
public class Place2Activity extends MatchParentActivity {
    ...
    private  void initView()
    {
        ...
        menu.addItem(new MenuItem.Builder().setWidth(120).setBackground(new ColorDrawable(Color.RED)).setText("删除").setDirection(MenuItem.DIRECTION_RIGHT).setTextColor(Color.WHITE).build());
        menu.addItem(new MenuItem.Builder().setWidth(120).setText("编辑").setBackground(new ColorDrawable(Color.BLUE)).setDirection(MenuItem.DIRECTION_RIGHT).setTextColor(Color.WHITE).build());
        menu.addItem(new MenuItem.Builder().setWidth(120).setBackground(new ColorDrawable(Color.GRAY)).setText("定位").setDirection(MenuItem.DIRECTION_RIGHT).setTextColor(Color.WHITE).build());
