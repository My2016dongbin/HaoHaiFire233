...
public class MyModalDialog {
    ...
    private MyModalDialog.MyModalDialogDelegate delegate;
    private Object tag;
    ...
    public MyModalDialog(int title, MyModalDialog.MyModalDialogDelegate delegate)
    {
        this(TEApp.getAppContext().getString(title), delegate);
    }

    public MyModalDialog(String title, MyModalDialog.MyModalDialogDelegate delegate)
    {
