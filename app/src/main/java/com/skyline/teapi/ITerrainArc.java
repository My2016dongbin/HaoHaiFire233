...
public final class ITerrainArc extends TEIUnknownHandle {
    private ITerrainArc(int handle)
    {
        super(handle);
    }    
    public static ITerrainArc fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrainArc(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("9B56BB63-0D6E-47BE-9902-B5748E0DD8B9");
    ...
    public double getStartAngle() throws ApiException
    {
        checkDisposed();
        double result = (NativeGetStartAngle(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setStartAngle(double value) throws ApiException
    {
        checkDisposed();
        NativeSetStartAngle(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }

    public double getEndAngle() throws ApiException
    {
        checkDisposed();
        double result = (NativeGetEndAngle(this.getHandle()));
        TEErrorHelper.ThrowExceptionOnError();
        return result;
    }

    public void setEndAngle(double value) throws ApiException
    {
        checkDisposed();
        NativeSetEndAngle(this.getHandle(),value);
        TEErrorHelper.ThrowExceptionOnError();
    }
...
private static native double NativeGetStartAngle(int instance);

private static native void NativeSetStartAngle(int instance,double pVal);

private static native double NativeGetEndAngle(int instance);

private static native void NativeSetEndAngle(int instance,double pVal);
