...
public final class IMultiLineString extends TEIUnknownHandle {
    private IMultiLineString(int handle)
    {
        super(handle);
    }    
    public static IMultiLineString fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new IMultiLineString(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("84CE9DFE-65AD-11D5-85C1-0001023952C1");
