...
public final class ITerrain3DArrow extends TEIUnknownHandle {
    private ITerrain3DArrow(int handle)
    {
        super(handle);
    }    
    public static ITerrain3DArrow fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrain3DArrow(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("108993FB-6761-4281-A095-1A2E1E4E6A8E");
