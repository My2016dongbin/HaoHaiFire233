...
public final class IMultiPolygon extends TEIUnknownHandle {
    private IMultiPolygon(int handle)
    {
        super(handle);
    }    
    public static IMultiPolygon fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new IMultiPolygon(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("84CE9DFD-65AD-11D5-85C1-0001023952C1");
