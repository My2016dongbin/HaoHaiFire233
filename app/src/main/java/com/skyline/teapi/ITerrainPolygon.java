...
public final class ITerrainPolygon extends TEIUnknownHandle {
    ...
    public ITreeItem getTreeItem() throws ApiException  //这个是获取什么
    {
        checkDisposed();
    ...
    public IAttachment getAttachment() throws ApiException  //获取附件
    {
        checkDisposed();
    ...
    public ITimeSpan getTimeSpan() throws ApiException  //获取时间跨度
    {
        checkDisposed();
    ...
    public IGeometry getGeometry() throws ApiException //获取几何
    {
        checkDisposed();
    ...
    public boolean getSpline() throws ApiException  //获取样条（仿样）？
    {
        checkDisposed();
    ...
    public boolean getExtendToGround() throws ApiException  //得到延伸到地面
    {
        checkDisposed();
