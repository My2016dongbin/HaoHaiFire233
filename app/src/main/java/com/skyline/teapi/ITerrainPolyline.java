...
public final class ITerrainPolyline extends TEIUnknownHandle {
    private ITerrainPolyline(int handle)
    {
        super(handle);
    }    
    public static ITerrainPolyline fromHandle(int handle)
    {
        if(handle == 0)
            return null;
        return new ITerrainPolyline(handle);
    }
    private final static java.util.UUID IID = java.util.UUID.fromString("B7E41578-928E-415D-AB21-73B42C01AF4D");
