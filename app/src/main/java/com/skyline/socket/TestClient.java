...
//                            client.sendString("我爱中国");
    ...
    private void setupAddress(SocketClient socketClient) {
        ...
        socketClient.getAddress().setRemoteIP("192.168.1.249"); // 远程端IP地址
...
//        socketClient.getHeartBeatHelper().setDefaultSendData(CharsetUtil.stringToData("HeartBeat", CharsetUtil.UTF_8));
        socketClient.getHeartBeatHelper().setDefaultSendData(new byte[]{0x01, 0x02});
    ...
    private void setupReadByLengthForSender(SocketClient socketClient) {
         ...
         */
        //包头
        //socketClient.getSocketPacketHelper().setSendHeaderData(CharsetUtil.stringToData("0531", CharsetUtil.UTF_8));
        socketClient.getSocketPacketHelper().setSendHeaderData(new byte[]{0x11,0x12});
        ...
        //包尾
        socketClient.getSocketPacketHelper().setSendTrailerData(new byte[]{0x13, 0x14});
