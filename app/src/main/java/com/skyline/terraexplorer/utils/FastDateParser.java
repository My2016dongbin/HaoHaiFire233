...
public class FastDateParser implements DateParser, Serializable {
    ...
    private static final FastDateParser.c m = new b(1) {
    ...
    private static final FastDateParser.c n = new b(2) {
        int a(int var1) {
            return var1 - 1;
        }
    };
    private static final FastDateParser.c o = new b(1);
    private static final FastDateParser.c p = new b(3);
    private static final FastDateParser.c q = new b(4);
    private static final FastDateParser.c r = new b(6);
    private static final FastDateParser.c s = new b(5);
    private static final FastDateParser.c t = new b(8);
    private static final FastDateParser.c u = new b(11);
    private static final FastDateParser.c v = new b(11) {
        int a(int var1) {
            return var1 % 24;
        }
    };
    private static final FastDateParser.c w = new b(10) {
        int a(int var1) {
            return var1 % 12;
        }
    };
    private static final FastDateParser.c x = new b(10);
    private static final FastDateParser.c y = new b(12);
    private static final FastDateParser.c z = new b(13);
    private static final FastDateParser.c A = new b(14);
        ...
        if(!var4.lookingAt()) {
            ...
            while(true) {
                ...
                if(!var4.lookingAt()) {
                    ...
                    this.i = null;
                    this.h = (FastDateParser.c[])var3.toArray(new c[var3.size()]);
    ...
    private FastDateParser.c a(String var1, Calendar var2) {
        switch(var1.charAt(0)) {
            case '\'':
                if(var1.length() > 2) {
                    return new a(var1.substring(1, var1.length() - 1));
                }
            case '(':
            case ')':
            case '*':
    ...
    private FastDateParser.c a(int var1, Calendar var2) {
        ...
        if(var4 == null) {
            var4 = var1 == 15?new e(this.d):new d(var1, var2, this.d);
