...
public class FastDatePrinter implements DatePrinter, Serializable {
    ...
    private void a() {
        ...
        this.d = (Rule[])var1.toArray(new Rule[var1.size()]);
        int var2 = 0;
        ...
        for(int var11 = 0; var11 < var9; ++var11) {
            ...
            switch(var15) {
                ...
                case 'D':
                    ...
                    break;
                case 'E':
                    var14 = new d(7, var13 < 4?var7:var6);
                    break;
                case 'F':
                ...
                case 'd':
                    ...
                    break;
                case 'h':
                    var14 = new h(this.selectNumberRule(10, var13));
                    break;
                case 'k':
                    var14 = new i(this.selectNumberRule(11, var13));
                    break;
                case 'm':
                ...
                case 'z':
                    if(var13 >= 4) {
                        var14 = new f(this.b, this.c, 1);
                    } else {
                        var14 = new f(this.b, this.c, 0);
                    }
            }
    ...
    protected NumberRule selectNumberRule(int var1, int var2) {
        switch(var2) {
            case 1:
                return new n(var1);
            case 2:
    ...
    static String a(TimeZone var0, boolean var1, int var2, Locale var3) {
        FastDatePrinter.e var4 = new e(var0, var1, var2, var3);
    ...
    private static class g implements Rule {
        static final g a = new g(true);
    ...
    private static class f implements Rule {
    ...
    private static class i implements NumberRule {
    ...
    private static class h implements NumberRule {
        private final NumberRule a;
    ...
    private static class j implements NumberRule {
    ...
    private static class l implements NumberRule {
    ...
    private static class k implements NumberRule {
        private final int a;
    ...
    private static class b implements NumberRule {
        private final int a;
        private final int b;
    ...
    private static class m implements NumberRule {
    ...
    private static class n implements NumberRule {
        private final int a;
    ...
    private static class d implements Rule {
        private final int a;
    ...
    private static class c implements Rule {
        private final String a;
