...
public class JobOrder {
    ...
    public JobOrder(String createUser, String updateUser, String createTime, String updateTime, String groupId, String id, String name, String status, String districtName, String districtNo, String streetName, String streetNo, int checkStationCount, int teamCount, int repositoryCount, String startTime, String endTime, String executeUser, String description) {
