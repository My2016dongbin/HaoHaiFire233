...
import com.skyline.terraexplorer.controllers.ResourceSelectActivity;
 ...
 * 重点资源管理工具菜单
 */
public class ResourcesTool extends BaseTool implements ISGWorld.OnLoadFinishedListener {
	...
	public ResourcesTool()
	{
		UI.runOnRenderThreadAsync(new Runnable() {
			@Override
			public void run() {
				ISGWorld.getInstance().addOnLoadFinishedListener(ResourcesTool.this);
			}
		});
	}
	@Override
	public MenuEntry getMenuEntry() {
		return MenuEntry.createFor(this, R.string.tool_res_title, R.drawable.ic_zhongdian, 30);
	}
	
	@Override
	public void open(Object param) {
		final Intent in = new Intent(TEApp.getCurrentActivityContext(), ResourceSelectActivity.class);
