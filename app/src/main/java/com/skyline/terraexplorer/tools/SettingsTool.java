...
public class SettingsTool extends BaseTool implements ISGWorld.OnLoadFinishedListener {
    ...
    public SettingsTool() {
        ...
        exitUGView.addView(exitUGLabel, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
    ...
    public void OnLoadFinished(boolean bSuccess) {
        ...
        // clear underground mode. We start with underground mode off 清除地下模式。 我们从地下模式开始
        prefs.edit().putBoolean(TEApp.getAppContext().getString(R.string.key_underground_button), false).apply();
    }
