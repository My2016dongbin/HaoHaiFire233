...
public class FavoritesStorage {
    ...
    protected class FavoritesStorageFeatureLayer extends FavoritesStorage implements ISGWorld.OnLoadFinishedListener {
    ...
    public int[] iconList() {
        return new int[]{R.drawable.star_red, R.drawable.star_green, R.drawable.star_purple, R.drawable.star_blue, R.drawable.star_yellow,R.drawable.fire,R.drawable.icon_rsfire};
    }
    ...
    public String descriptionForIcon(int icon) {
        ...
        switch (icon) {
            ...
            case 6:
                return TEApp.getAppContext().getString(R.string.favorite_icon_rs_fire);
        }
        return "";
    }
