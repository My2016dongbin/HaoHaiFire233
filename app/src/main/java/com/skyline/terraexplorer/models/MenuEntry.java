...
public class MenuEntry {
	...
	public  static  String MenuEntrySearchResource()
    {
        return  String.format("%d|%d|40", R.string.searchresource_tool_name, R.drawable.tool_resource_query);
    }
	...
	public static  String MenuEntryPlot()
	{
		return  String.format("%d|%d|40",R.string.mm_plottool,R.drawable.whiteboard);
	}
