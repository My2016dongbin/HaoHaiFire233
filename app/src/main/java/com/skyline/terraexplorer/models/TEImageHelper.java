...
public class TEImageHelper {
	 ...
	 * @return
	 */
	public static String prepareImageForTE(int imageId, int imageSize){
		ImageSize = imageSize;
		return prepareImageForTE(imageId, Integer.toString(imageId));
	}
	...
	public static String prepareImageForTE(int imageId, String imageName)
	{
		if(TEAppData == null)
		{
			...
			// bug fix #18757
			// for some reason 65 works for all our devices, while using 48/65 does not :( 由于某些原因65适用于我们所有的设备，而使用48/65不:(
			ImageSize = 65;
		}
