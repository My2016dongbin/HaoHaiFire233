...
/**
 * Created by geyang on 2019/10/15.
 */
...
public class LinePathView extends View {
    ...
    public void save(String path, boolean clearBlank, int blank) throws IOException {
        /*
        BitmapDrawable bitmapDrawable = (BitmapDrawable) MyApplication.getAppContext().getResources().getDrawable(R.mipmap.ic_back);
        ...
        Bitmap.Config config = cachebBitmap.getConfig();
        Bitmap bitmap = Bitmap.createBitmap(cachebBitmap.getWidth(), cachebBitmap.getHeight(), config);
        Canvas canvas = new Canvas(bitmap);
        canvas.drawRect(0, 0, cachebBitmap.getWidth(), cachebBitmap.getHeight(), paint);
