 ...
 *
 */
package com.skyline.terraexplorer.views.progress;
...
abstract class BaseProgressView extends View {
    ...
    protected int color = getResources().getColor(R.color.c21), backgroundColor = Color.WHITE;
    protected int textColor = getResources().getColor(R.color.c21);
    protected int shadowColor = getResources().getColor(R.color.c21);
