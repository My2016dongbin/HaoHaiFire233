...
//        final RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "auth/api/auth/user/login/default");
//        params.setConnectTimeout(10000);
        final RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "auth/oauth/token");
        // params.addBodyParameter("reqJson", jsonObject.toString());
        params.addParameter("username","admin");
        params.addParameter("password","a123456");
        params.addParameter("grant_type","password");
        params.addParameter("client_id","client_password");
        params.addParameter("client_secret","123456");
        params.setConnectTimeout(10000);
                    ...
                    if (code.equals("200")){
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            try {
                                ...
                                CheckField checkField = new CheckField(id, code1, createTime, createUser, description, fieldType, groupId, name, resourceType, updateTime, updateUser,1);
