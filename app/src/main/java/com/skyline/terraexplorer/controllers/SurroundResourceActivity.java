...
public class SurroundResourceActivity extends HBaseActivity implements ThreeGridViewBinder.OnThreeGridItemClickListener,INaviInfoCallback {
                    ...
                    public void call(Void aVoid) {
                      ...
                      /*  for (int i = 0; i < chooseList.size(); i++) {
                            ...
                            if (i == chooseList.size() - 1){
                                //终点
                                com.haohai.platform.zhlynew.qdgridapp.terraexplorer.utils.LatLng latLng = new LatLngChange().transformFromWGSToGCJ(new com.haohai.platform.zhlynew.qdgridapp.terraexplorer.utils.LatLng(Double.parseDouble(chooseList.get(i).getLat()),Double.parseDouble(chooseList.get(i).getLng())));
    ...
    private void getDataFromService() {
        ...
        Log.e(TAG, "getDataFromService: bingo " + jsonObject.toString() );
