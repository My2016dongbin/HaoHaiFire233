...
public class AddlcpzlglActivity extends BaseActivity implements DatePicker.OnDateChangedListener{
    private ActionBar actionBar;
    private ActivityAddlcpzljgBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_addlcpzljg);
        initView();
        initDateTime();
        getDataFromService();
    }
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if (uriChooseList.size() == 2){
                            Toast.makeText(AddlcpzlglActivity.this, "最多可以添加两张图片", Toast.LENGTH_SHORT).show();
                        }else {
                            addImage();
                        }
                    }
    ...
    private void postDataToService() {
        ...
        try {
            ...
            jsonObject.put("treeSpecies",binding.szEdit.getText().toString());
            jsonObject.put("year",binding.nxEdit.getText().toString());
            if (!binding.mclEdit.getText().toString().equals("")){
                jsonObject.put("output",Double.parseDouble(binding.mclEdit.getText().toString()));
            }
            if (!binding.jiageEdit.getText().toString().equals("")){
                jsonObject.put("price",Double.parseDouble(binding.jiageEdit.getText().toString()));
            }
            jsonObject.put("sampleUnit",binding.cjdwEdit.getText().toString());
            jsonObject.put("sampleType",binding.cjlxEdit.getText().toString());
            jsonObject.put("sampleDate",binding.jianchashijianView.getText().toString()+" 00:00:00");
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/forestProductSampleCheck" );
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        Toast.makeText(AddlcpzlglActivity.this, "上传成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }else {
                        Toast.makeText(AddlcpzlglActivity.this, "上传失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//        Log.e(TAG, "onActivityResult:data ",data);
            ...
            Bitmap photo = null;
            try {
                photo = ImageUtils.getBitmapFormUri(AddlcpzlglActivity.this, uri);
            } catch (IOException e) {
            }
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        Toast.makeText(AddlcpzlglActivity.this, "提交失败", Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        Toast.makeText(AddlcpzlglActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
