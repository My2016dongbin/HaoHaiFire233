 ...
 */
public class LyzyBarListViewBinder extends ItemViewBinder<YllhBarList.ChildrenDataFirejd, LyzyBarListViewBinder.ViewHolder> {
    @NonNull
    @Override
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.item_lyzy_bar_list, parent, false);
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, @NonNull final YllhBarList.ChildrenDataFirejd childrenDataFirejd) {
        ...
        holder.mjView.setText(String.valueOf(childrenDataFirejd.getEachAcreages()));
    }
