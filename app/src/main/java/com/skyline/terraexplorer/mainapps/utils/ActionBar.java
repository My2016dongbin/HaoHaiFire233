 ...
 //   private ActionBarMenu menu;
   // private ActionBarMenu actionMode;
    ...
    private void initView(Context context) {
        ...
        addView(content,LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT,150));
        ...
        backButtonImageView.setImageResource(R.mipmap.ic_back);
        backgroundLayout.addView(backButtonImageView, LayoutHelper.createFrame(60,60, Gravity.CENTER_VERTICAL,20,20,0,0));
        ...
        content.addView(titleView,LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT,LayoutHelper.WRAP_CONTENT, Gravity.CENTER,0,20,0,0));
        ...
        content.addView(rightView,LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT,LayoutHelper.WRAP_CONTENT, Gravity.CENTER_VERTICAL| Gravity.RIGHT,0,20,20,0));
