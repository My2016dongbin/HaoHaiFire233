 ...
 */
public class LcpzljgViewBinder extends ItemViewBinder<Lcpzljg, LcpzljgViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Lcpzljg lcpzljg) {
        holder.textView1.setText("基地名称: " + lcpzljg.getProductionBaseName() );
        holder.textView2.setText("年限: " + lcpzljg.getYear() );
        holder.textView3.setText("抽检时间: " + lcpzljg.getSampleDate() );
        holder.textView4.setText("抽检单位: " + lcpzljg.getSampleUnit() );
        holder.textView5.setText("备注: " + lcpzljg.getRemark() );
