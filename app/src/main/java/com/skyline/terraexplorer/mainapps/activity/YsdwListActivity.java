...
import com.skyline.terraexplorer.mainapps.multitype.YsdwViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Ysdwjd;
...
public class YsdwListActivity extends BaseActivity {
    private static final String TAG = YsdwListActivity.class.getSimpleName();
    ...
    private List<Ysdwjd> firejdList;
    private List<Ysdwjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/wildlifeSupervisionAndInspection/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Ysdwjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(YsdwListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/wildlifeSupervisionAndInspection/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Ysdwjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(YsdwListActivity.this, AddysdwActivity.class);
...
*/
    ...
    private void register() {
        YsdwViewBinder ysdwViewBinder = new YsdwViewBinder();
        adapter.register(Ysdwjd.class, ysdwViewBinder);
