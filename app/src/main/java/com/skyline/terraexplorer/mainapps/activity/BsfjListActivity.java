...
import com.skyline.terraexplorer.mainapps.multitype.BsfjViewBinder;
...
public class BsfjListActivity extends BaseActivity implements BsfjViewBinder.OnBsxxItemClick{
    private static final String TAG = BsfjListActivity.class.getSimpleName();
    ...
    private List<Bsfjjd> firejdList;
    private List<Bsfjjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/sickTreeSectionInfo/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Bsfjjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(BsfjListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(BsfjListActivity.this, AddbsfjActivity.class);
...
*/
    ...
    private void register() {
        BsfjViewBinder bsfjViewBinder = new BsfjViewBinder();
        bsfjViewBinder.setListener(this);
        adapter.register(Bsfjjd.class, bsfjViewBinder);
