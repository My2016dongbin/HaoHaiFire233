...
import com.skyline.terraexplorer.mainapps.multitype.SdbhViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Sdbhjd;
...
public class SdbhListActivity extends BaseActivity {
    private static final String TAG = SdbhListActivity.class.getSimpleName();
    ...
    private List<Sdbhjd> firejdList;
    private List<Sdbhjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/wetlandProtectionSupervisionAndInspection/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Sdbhjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(SdbhListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/wetlandProtectionSupervisionAndInspection/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Sdbhjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(SdbhListActivity.this, AddsdbhActivity.class);
...
*/
    ...
    private void register() {
        SdbhViewBinder sdbhViewBinder = new SdbhViewBinder();
        adapter.register(Sdbhjd.class, sdbhViewBinder);
