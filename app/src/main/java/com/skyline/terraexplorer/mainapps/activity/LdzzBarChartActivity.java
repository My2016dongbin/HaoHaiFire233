...
public class LdzzBarChartActivity extends BaseActivity  {
    private static final String TAG = LdzzBarChartActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ldzz_barchart);
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        initData();
                        xmView.setText("青岛市林地征占"+yllhBarList.getTotalCount()+"个，总面积"+yllhBarList.getTotalAcreages()+"亩");
                    }else {
                        Toast.makeText(LdzzBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
