 ...
 */
public class XmzlViewBinder extends ItemViewBinder<xmzljd, XmzlViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull xmzljd xmzljd) {
        holder.textView1.setText("项目名称: " + xmzljd.getName() );
        holder.textView2.setText("项目经理: " + xmzljd.getHead() );
        String isCompleteExpectedTasks = xmzljd.isCompleteExpectedTasks()==true ? "是":"否";
        holder.textView3.setText("是否完成节点任务: " + isCompleteExpectedTasks);
        holder.textView4.setText("上报时间: " + xmzljd.getReportTime());
