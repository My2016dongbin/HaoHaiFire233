...
public class SsjdListActivity extends BaseActivity {
    private static final String TAG = SsjdListActivity.class.getSimpleName();
    ...
    private List<ssjd> firejdList;
    private List<ssjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectScheduleManagement/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<ssjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(SsjdListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectScheduleManagement/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<ssjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(SsjdListActivity.this, AddssjdActivity.class);
...
*/
    ...
    private void register() {
        SSjdViewBinder sSjdViewBinder = new SSjdViewBinder();
        adapter.register(ssjd.class, sSjdViewBinder);
