...
import com.skyline.terraexplorer.mainapps.multitype.LyzyBarListViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.YearData;
...
public class OtherBarChartActivity extends BaseActivity {
    private static final String TAG = com.skyline.terraexplorer.mainapps.activity.OtherBarChartActivity.class.getSimpleName();
...
/*        Intent intent =getIntent();
    ...
    private void initView() {
        ...
        LyzyBarListViewBinder barListViewBinder = new LyzyBarListViewBinder();
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        Toast.makeText(OtherBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
