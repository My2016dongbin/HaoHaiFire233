...
import com.skyline.terraexplorer.mainapps.multitype.SSjdViewBinder;
...
import com.skyline.terraexplorer.mainapps.multitype.ssjd;
...
public class XmzlListActivity extends BaseActivity {
    private static final String TAG = XmzlListActivity.class.getSimpleName();
    ...
    private List<xmzljd> firejdList;
    private List<xmzljd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectQualityManagement/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<xmzljd>>() {
                        }.getType());
                        ...
                        Toast.makeText(XmzlListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectQualityManagement/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<xmzljd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(XmzlListActivity.this, AddxmzlActivity.class);
...
*/
    ...
    private void register() {
        XmzlViewBinder xmzlViewBinder = new XmzlViewBinder();
        adapter.register(xmzljd.class, xmzlViewBinder);
