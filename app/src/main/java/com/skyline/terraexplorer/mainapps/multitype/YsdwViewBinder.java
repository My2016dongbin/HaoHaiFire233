 ...
 */
public class YsdwViewBinder extends ItemViewBinder<Ysdwjd, YsdwViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Ysdwjd ysdwjd) {
        holder.textView1.setText("地区: " + ysdwjd.getRegion() );
        holder.textView2.setText("检查员: " + ysdwjd.getSignatureMonitor() );
        holder.textView3.setText("负责人: " + ysdwjd.getHead() );
        holder.textView4.setText("电话: " + ysdwjd.getPhone() );
        holder.textView5.setText("机构名称: " + ysdwjd.getSignatureWildlifeUnits() );
        String jcTime = ysdwjd.getInspectionTime()==null ? "" : ysdwjd.getInspectionTime();
