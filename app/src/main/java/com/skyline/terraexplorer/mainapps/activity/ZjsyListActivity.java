...
import com.skyline.terraexplorer.mainapps.multitype.XmzlViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.xmzljd;
...
public class ZjsyListActivity extends BaseActivity {
    private static final String TAG = ZjsyListActivity.class.getSimpleName();
    ...
    private List<zjsyjd> firejdList;
    private List<zjsyjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectFundUseManagement/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<zjsyjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(ZjsyListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectFundUseManagement/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<zjsyjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(ZjsyListActivity.this, AddzjsyActivity.class);
...
*/
    ...
    private void register() {
        zjsyViewBinder zjsyViewBinder = new zjsyViewBinder();
        adapter.register(zjsyjd.class, zjsyViewBinder);
