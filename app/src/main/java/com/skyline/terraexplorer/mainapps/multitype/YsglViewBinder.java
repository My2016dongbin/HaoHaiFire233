 ...
 */
public class YsglViewBinder extends ItemViewBinder<Ysgljd, YsglViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Ysgljd ysgljd) {
        holder.textView1.setText("项目名称: " + ysgljd.getName() );
        String isCompleted = ysgljd.isCompleted()==true ? "是":"否";
        holder.textView2.setText("是否到位: " + isCompleted);
        holder.textView3.setText("验收时间: " + ysgljd.getReceptionTime());
        holder.textView4.setText("备注: " + ysgljd.getRemark());
