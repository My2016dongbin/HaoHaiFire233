 ...
 */
public class FzxxViewBinder extends ItemViewBinder<fzxxjd, FzxxViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull fzxxjd fzxxjd) {
        holder.textView1.setText("地区: " + fzxxjd.getRegion() );
        holder.textView2.setText("发生位置: " + fzxxjd.getOccurrenceAddress() );
        holder.textView3.setText("发生面积（亩）: " + fzxxjd.getOccurrenceArea() );
        holder.textView4.setText("发生时间: " + fzxxjd.getOccurrenceTime() );
        holder.textView5.setText("防治时间: " + fzxxjd.getPreventTime() );
