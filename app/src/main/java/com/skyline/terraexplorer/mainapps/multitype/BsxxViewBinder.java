 ...
 */
public class BsxxViewBinder extends ItemViewBinder<Bsxxjd, BsxxViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Bsxxjd bsxxjd) {
        holder.textView1.setText("小班号: " + bsxxjd.getSmallClassNo() );
        holder.textView2.setText("调查人: " + bsxxjd.getInquirer() );
        String jcTime = bsxxjd.getSurveyTime()==null ? "" : bsxxjd.getSurveyTime();
        holder.textView3.setText("调查时间: " + jcTime);
        holder.textView4.setText("树木编号: " + bsxxjd.getTreeNo() );
        holder.textView5.setText("区县: " + bsxxjd.getCounty() );
        holder.textView6.setText("乡镇（街道）: " + bsxxjd.getVillage() );
        holder.textView7.setText("村（居委会）: " + bsxxjd.getTown());
        holder.textView8.setText("备注: " + bsxxjd.getRemark());
        holder.textView9.setText("小地名: " + bsxxjd.getSmallPlaces());
        RxViewAction.clickNoDouble(holder.orderLayout)
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        Log.e("TAG", "call: "+bsxxjd.getId() );
                        listener.onBsxxItemClickListener(bsxxjd.getId());
                    }
                });
    }
