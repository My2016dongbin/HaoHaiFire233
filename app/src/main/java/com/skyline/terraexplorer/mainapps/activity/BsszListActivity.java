...
import com.skyline.terraexplorer.mainapps.multitype.BsszViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Bsszjd;
...
public class BsszListActivity extends BaseActivity implements BsszViewBinder.OnBsxxItemClick{
    private static final String TAG = BsszListActivity.class.getSimpleName();
    ...
    private List<Bsszjd> firejdList;
    private List<Bsszjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/sickTreeStumpInfo/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Bsszjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(BsszListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(BsszListActivity.this, AddbsysActivity.class);
...
*/
    ...
    private void register() {
        BsszViewBinder bsszViewBinder = new BsszViewBinder();
        bsszViewBinder.setListener(this);
        adapter.register(Bsszjd.class, bsszViewBinder);
