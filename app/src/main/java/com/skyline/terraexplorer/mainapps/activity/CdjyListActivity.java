...
public class CdjyListActivity extends BaseActivity {
    private static final String TAG = CdjyListActivity.class.getSimpleName();
    ...
    private List<cdjyjd> firejdList;
    private List<cdjyjd> firejdTypeList;
    ...
    private User user;
    private ActivityCdjylistBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       // setContentView(R.layout.activity_fanghuolist);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_cdjylist);
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestOriginQuarantine/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<cdjyjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(CdjyListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(CdjyListActivity.this, AddycdjyActivity.class);
...
*/
    ...
    private void selectdata() {
        ...
        try {
            JSONObject dto = new JSONObject();
            jsonObject.put("enterpriseName",binding.qymcEdit.getText().toString());
            jsonObject.put("dto", dto);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestOriginQuarantine/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<cdjyjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
    ...
    private void register() {
        CdjyViewBinder cdjyViewBinder = new CdjyViewBinder();
        adapter.register(cdjyjd.class, cdjyViewBinder);
