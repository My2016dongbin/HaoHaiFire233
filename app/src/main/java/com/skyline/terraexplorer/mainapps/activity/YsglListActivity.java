...
import com.skyline.terraexplorer.mainapps.multitype.YsglViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Ysgljd;
import com.skyline.terraexplorer.mainapps.multitype.zjsyViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.zjsyjd;
...
public class YsglListActivity extends BaseActivity {
    private static final String TAG = YsglListActivity.class.getSimpleName();
    ...
    private List<Ysgljd> firejdList;
    private List<Ysgljd> firejdTypeList;
    ...
    private ActivitySsjdlistBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       // setContentView(R.layout.activity_fanghuolist);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_ssjdlist);
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectAcceptanceManagement/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        xmnameList.clear();
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Ysgljd>>() {
                        }.getType());
                        ...
                        Toast.makeText(YsglListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        try {
            ...
            jsonObject.put("name", binding.orderStateView.getText());
            jsonObject.put("dto", dto);

        } catch (JSONException e) {
            e.printStackTrace();
        }
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectAcceptanceManagement/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Ysgljd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(YsglListActivity.this, AddysglActivity.class);
...
*/
    ...
    private void register() {
        YsglViewBinder ysglViewBinder = new YsglViewBinder();
        adapter.register(Ysgljd.class, ysglViewBinder);
