...
public class LcpzljgListActivity extends BaseActivity {
    private static final String TAG = LcpzljgListActivity.class.getSimpleName();
    ...
    private List<Lcpzljg> firejdList;
    private List<Lcpzljg> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "forestry/api/forestProductSampleCheck/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Lcpzljg>>() {
                        }.getType());
                        ...
                        Toast.makeText(LcpzljgListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/forestProductSampleCheck/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Lcpzljg>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(LcpzljgListActivity.this, AddlcpzlglActivity.class);
...
*/
    ...
    private void register() {
        LcpzljgViewBinder lcpzljgViewBinder = new LcpzljgViewBinder();
        adapter.register(Lcpzljg.class, lcpzljgViewBinder);
