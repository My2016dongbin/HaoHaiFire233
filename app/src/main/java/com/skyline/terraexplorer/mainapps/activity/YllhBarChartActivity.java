...
public class YllhBarChartActivity extends BaseActivity  {
    private static final String TAG = com.skyline.terraexplorer.mainapps.activity.YllhBarChartActivity.class.getSimpleName();
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        initData();
                        xmView.setText("项目总数"+yllhBarList.getTotalCount()+"个，项目总面积"+yllhBarList.getTotalAcreages()+"亩");
                    }else {
                        Toast.makeText(YllhBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
