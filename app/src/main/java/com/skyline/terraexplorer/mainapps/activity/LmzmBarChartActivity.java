...
public class LmzmBarChartActivity extends BaseActivity  {
    private static final String TAG = LmzmBarChartActivity.class.getSimpleName();
    ...
    private int month;
    private int day;
    private FrameLayout nfxcView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lmzm_barchart);
...
/*        Intent intent =getIntent();
    ...
    private void initView() {
        ...
        nfxcView=findViewById(R.id.nfxc_view);
        nfxcView.setVisibility(View.GONE);
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        initData();
                        xmView.setText("青岛市林木种苗苗圃"+yllhBarList.getTotalCount()+"个，总面积"+yllhBarList.getTotalAcreages()+"亩");
                    }else {
                        Toast.makeText(LmzmBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
