...
public class XmglListActivity extends BaseActivity {
    private static final String TAG = XmglListActivity.class.getSimpleName();
    ...
    private List<Xmgljd> firejdList;
    private List<Xmgljd> firejdTypeList;
    ...
    private User user;
    private ActivityXmgllistBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       // setContentView(R.layout.activity_fanghuolist);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_xmgllist);
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/projectPlanningAndManagement/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Xmgljd>>() {
                        }.getType());
                        ...
                        Toast.makeText(XmglListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Xmgljd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(XmglListActivity.this, AddxmglActivity.class);
...
*/
    ...
    private void register() {
        XmglViewBinder xmglViewBinder = new XmglViewBinder();
        adapter.register(Xmgljd.class, xmglViewBinder);
