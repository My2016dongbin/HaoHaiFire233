...
public class BsysListActivity extends BaseActivity implements BsysViewBinder.OnBsxxItemClick{
    private static final String TAG = BsysListActivity.class.getSimpleName();
    ...
    private List<Bsysjd> firejdList;
    private List<Bsysjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/sickTreeTransportInfo/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Bsysjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(BsysListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(BsysListActivity.this, AddbsysActivity.class);
...
*/
    ...
    private void register() {
        BsysViewBinder bsysViewBinder = new BsysViewBinder();
        bsysViewBinder.setListener(this);
        adapter.register(Bsysjd.class, bsysViewBinder);
