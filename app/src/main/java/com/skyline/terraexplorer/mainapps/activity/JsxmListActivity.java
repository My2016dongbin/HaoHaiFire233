...
public class JsxmListActivity extends BaseActivity {
    private static final String TAG = JsxmListActivity.class.getSimpleName();
    ...
    private List<Jsxmjd> firejdList;
    private List<Jsxmjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/constructionProjectUsesWoodland/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Jsxmjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(JsxmListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/constructionProjectUsesWoodland/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Jsxmjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(JsxmListActivity.this, AddjsxmActivity.class);
...
*/
    ...
    private void register() {
        JsxmViewBinder jsxmViewBinder = new JsxmViewBinder();
        adapter.register(Jsxmjd.class, jsxmViewBinder);
