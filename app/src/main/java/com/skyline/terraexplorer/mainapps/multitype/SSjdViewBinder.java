 ...
 */
public class SSjdViewBinder extends ItemViewBinder<ssjd, SSjdViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull ssjd ssjd) {
        holder.textView1.setText("项目名称: " + ssjd.getName() );
        holder.textView2.setText("填报人: " + ssjd.getFillInPerson() );
        holder.textView3.setText("填报时间: " + ssjd.getFillInTime() );
        holder.textView4.setText("项目节点: " + ssjd.getNode() );
