 ...
 */
public class BsszViewBinder extends ItemViewBinder<Bsszjd, BsszViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Bsszjd bsszjd) {
        holder.textView1.setText("名称: " + bsszjd.getPerson() );
        holder.textView2.setText("树桩状态: " + bsszjd.getStumpState() );
        String jcTime = bsszjd.getTime()==null ? "" : bsszjd.getTime();
        holder.textView3.setText("时间: " + jcTime);
        holder.textView4.setText("小地名: " + bsszjd.getSmallPlaces() );
        holder.textView5.setText("备注: " + bsszjd.getRemark());
        ...
        RxViewAction.clickNoDouble(holder.orderLayout)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        Log.e("TAG", "call: "+bsszjd.getId() );
                        listener.onBsxxItemClickListener(bsszjd.getId());
                    }
                });
    }
