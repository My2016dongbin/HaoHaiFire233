...
import com.skyline.terraexplorer.mainapps.multitype.LmcfViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.YhswfkViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Yhswfkjd;
import com.skyline.terraexplorer.mainapps.multitype.lmcfjd;
...
public class YhswfkListActivity extends BaseActivity {
    private static final String TAG = YhswfkListActivity.class.getSimpleName();
    ...
    private List<Yhswfkjd> firejdList;
    private List<Yhswfkjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestControlSupervisionAndInspection/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Yhswfkjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(YhswfkListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestControlSupervisionAndInspection/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Yhswfkjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(YhswfkListActivity.this, AddyhswfkActivity.class);
...
*/
    ...
    private void register() {
        YhswfkViewBinder yhswfkViewBinder = new YhswfkViewBinder();
        adapter.register(Yhswfkjd.class, yhswfkViewBinder);
