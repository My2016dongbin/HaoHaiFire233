...
import com.skyline.terraexplorer.mainapps.multitype.BsxxViewBinder;
...
public class BsglListActivity extends BaseActivity implements BsxxViewBinder.OnBsxxItemClick{
    private static final String TAG = BsglListActivity.class.getSimpleName();
    ...
    private List<Bsxxjd> firejdList;
    private List<Bsxxjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/sickTreeInfo/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Bsxxjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(BsglListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(BsglListActivity.this, AddbsxxActivity.class);
...
*/
    ...
    private void register() {
        BsxxViewBinder bsxxViewBinder = new BsxxViewBinder();
        bsxxViewBinder.setListener(this);
        adapter.register(Bsxxjd.class, bsxxViewBinder);
