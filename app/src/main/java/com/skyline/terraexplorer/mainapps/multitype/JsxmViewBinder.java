 ...
 */
public class JsxmViewBinder extends ItemViewBinder<Jsxmjd, JsxmViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Jsxmjd jsxmjd) {
        holder.textView1.setText("地区: " + jsxmjd.getRegion() );
        holder.textView2.setText("检查人: " + jsxmjd.getSignatureMonitor() );
        holder.textView3.setText("负责人: " + jsxmjd.getHead() );
        holder.textView4.setText("电话: " + jsxmjd.getPhone() );
        holder.textView5.setText("使用林地单位: " + jsxmjd.getSignatureForestUnits() );
        holder.textView6.setText("地址: " + jsxmjd.getAddress() );
        String jcTime = jsxmjd.getInspectionTime()==null ? "" : jsxmjd.getInspectionTime();
