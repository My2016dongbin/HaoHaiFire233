...
public class YhswBarChartActivity extends BaseActivity  {
    private static final String TAG = YhswBarChartActivity.class.getSimpleName();
...
//        Log.e(TAG, "initData: " + getbarchartList.size());
    ...
    private void getDataFromService() {
        ...
        params.addParameter("type","yhswfz");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        initData();
                        xmView.setText("青岛市病死松树"+yllhBarList.getTotalCount()+"个，发生面积"+yllhBarList.getTotalAcreages()+"亩");
                    }else {
                        Toast.makeText(YhswBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
