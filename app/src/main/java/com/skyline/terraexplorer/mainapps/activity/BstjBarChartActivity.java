...
import com.skyline.terraexplorer.mainapps.multitype.BstjBarListViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Gylcjd;
...
public class BstjBarChartActivity extends BaseActivity  {
    private static final String TAG = BstjBarChartActivity.class.getSimpleName();
    ...
    private Bstjjd bstjjd;
    private List<Bstjjd> BstjList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yllh_barchart);
...
/*        Intent intent =getIntent();
    ...
    private void initView() {
        ...
        BstjBarListViewBinder bstjBarListViewBinder = new BstjBarListViewBinder();
        adapter1.register(Bstjjd.class, bstjBarListViewBinder);
...
//        Log.e(TAG, "initData: " + getbarchartList.size());
        ...
        Log.e(TAG, "initData: "+BstjList.size() );
        for (int i = 0; i < BstjList.size(); i++) {
            Log.e("initData: ", String.valueOf(BstjList.get(i).getTreeCount()));
            String val=(String.valueOf(BstjList.get(i).getTreeCount()));
            values.add(new BarEntry(i, Float.parseFloat(val)));
            getmfristData.add(BstjList.get(i).getTown());
            items1.add(BstjList.get(i));
    ...
    private void getDataFromService() {
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/sickTreeInfo/querySickTreeStatistics");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        Gson gson = new Gson();
                        BstjList=gson.fromJson(String.valueOf(data), new TypeToken<List<Bstjjd>>() {
                        }.getType());
                        //bstjjd=gson.fromJson(String.valueOf(data), Bstjjd.class);
                        initData();
                        xmView.setText("青岛市病树共"+count+"个");
                    }else {
                        Toast.makeText(BstjBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
