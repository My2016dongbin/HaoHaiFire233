 ...
 */
public class FirejdViewBinder extends ItemViewBinder<Firejd, FirejdViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Firejd firejd) {
        holder.textView1.setText("地区: " + firejd.getRegion() );
        holder.textView2.setText("检查人: " + firejd.getSignatureOfInspector() );
        holder.textView3.setText("负责人: " + firejd.getSignatureOfDirector() );
        holder.textView4.setText("被检单位: " + firejd.getInspectedUnit() );
        holder.textView5.setText("地址: " + firejd.getAddress() );
        String jcTime = firejd.getInspectionTime()==null ? "" : firejd.getInspectionTime();
