...
import com.skyline.terraexplorer.mainapps.multitype.SlgyViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.slgyjd;
...
public class SlgyListActivity extends BaseActivity {
    private static final String TAG = SlgyListActivity.class.getSimpleName();
    ...
    private List<slgyjd> firejdList;
    private List<slgyjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/forestParkSupervisionAndInspection/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<slgyjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(SlgyListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/forestParkSupervisionAndInspection/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<slgyjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(SlgyListActivity.this, AddslgyActivity.class);
...
*/
    ...
    private void register() {
        SlgyViewBinder slgyViewBinder = new SlgyViewBinder();
        adapter.register(slgyjd.class, slgyViewBinder);
