...
import com.skyline.terraexplorer.mainapps.multitype.scxcViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.scxcjd;
...
public class ScxcListActivity extends BaseActivity {
    private static final String TAG = ScxcListActivity.class.getSimpleName();
    ...
    private List<scxcjd> firejdList;
    private List<scxcjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestPineNematodeMonitor/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<scxcjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(ScxcListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestPineNematodeMonitor/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList.clear();
                        firejdTypeList.clear();
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<scxcjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(ScxcListActivity.this, AddscxcActivity.class);
...
*/
    ...
    private void register() {
        scxcViewBinder scxcViewBinder = new scxcViewBinder();
        adapter.register(scxcjd.class, scxcViewBinder);
