...
import com.skyline.terraexplorer.databinding.ActivityDyjylistBinding;
...
import com.skyline.terraexplorer.mainapps.multitype.DyjyViewBinder;
...
public class DyjyListActivity extends BaseActivity {
    private static final String TAG = DyjyListActivity.class.getSimpleName();
    ...
    private List<Adddyjy> firejdList;
    private List<Adddyjy> firejdTypeList;
    ...
    private User user;
    private ActivityDyjylistBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       // setContentView(R.layout.activity_fanghuolist);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_dyjylist);
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestTransportationQuarantine/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Adddyjy>>() {
                        }.getType());
                        ...
                        Toast.makeText(DyjyListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(DyjyListActivity.this, AdddyjyActivity.class);
...
*/
    ...
    private void selectdata() {
        ...
        try {
            JSONObject dto = new JSONObject();
            jsonObject.put("transportationUnit",binding.qymcEdit.getText().toString());
            jsonObject.put("dto", dto);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/pestTransportationQuarantine/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Adddyjy>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
    ...
    private void register() {
        DyjyViewBinder dyjyViewBinder = new DyjyViewBinder();
        adapter.register(Adddyjy.class, dyjyViewBinder);
