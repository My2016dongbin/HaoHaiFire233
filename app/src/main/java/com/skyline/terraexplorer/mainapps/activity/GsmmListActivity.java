...
import com.skyline.terraexplorer.mainapps.multitype.GsmmViewBinder;
...
import com.skyline.terraexplorer.mainapps.multitype.gsmmjd;
...
public class GsmmListActivity extends BaseActivity {
    private static final String TAG = GsmmListActivity.class.getSimpleName();
    ...
    private List<gsmmjd> firejdList;
    private List<gsmmjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/famousTreesProtectionInfo/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<gsmmjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(GsmmListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/famousTreesProtectionInfo/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList.clear();
                        firejdTypeList.clear();
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<gsmmjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(GsmmListActivity.this, AddgsmmActivity.class);
...
*/
    ...
    private void register() {
        GsmmViewBinder gsmmViewBinder = new GsmmViewBinder();
        adapter.register(gsmmjd.class, gsmmViewBinder);
