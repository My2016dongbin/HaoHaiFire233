 ...
 */
public class CheckfhjdViewBinder extends ItemViewBinder<Checkfhjd, CheckfhjdViewBinder.ViewHolder> {
    ...
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.item_check_fhjd, parent, false);
        return new ViewHolder(root);
    }

    @Override
    protected void onBindViewHolder(@NonNull final ViewHolder holder, @NonNull final Checkfhjd checkfhjd) {
        holder.nameView.setText(checkfhjd.getName());
        if (checkfhjd.state == 0){
        ...
        holder.switchButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                listener.onCheckFieldItemClickLinstener(checkfhjd.getId(),holder.switchButton.isChecked() ? 1 : 0);
            }
        });
