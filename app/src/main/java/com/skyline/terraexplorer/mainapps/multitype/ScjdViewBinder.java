 ...
 */
public class ScjdViewBinder extends ItemViewBinder<Scjd, ScjdViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Scjd scjd) {
        holder.textView1.setText("基地名称: " + scjd.getName() );
        holder.textView2.setText("地区: " + scjd.getRegion() );
        holder.textView3.setText("负责人: " + scjd.getHead() );
        holder.textView4.setText("电话: " + scjd.getPhone() );
        holder.textView5.setText("地址: " + scjd.getAddress() );
