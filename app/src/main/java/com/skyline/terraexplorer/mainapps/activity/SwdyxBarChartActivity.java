...
public class SwdyxBarChartActivity extends BaseActivity  {
    private static final String TAG = SwdyxBarChartActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swdyx_barchart);
...
//        Log.e(TAG, "initData: " + getbarchartList.size());
    ...
    private void getDataFromService() {
        ...
        params.addParameter("type","swdyx");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        initData();
                        xmView.setText("青岛市生物多样性"+yllhBarList.getTotalCount()+"个，总面积"+yllhBarList.getTotalAcreages()+"亩");
                    }else {
                        Toast.makeText(SwdyxBarChartActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
