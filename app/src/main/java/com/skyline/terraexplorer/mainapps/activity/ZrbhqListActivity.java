...
import com.skyline.terraexplorer.mainapps.multitype.JsxmViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Jsxmjd;
import com.skyline.terraexplorer.mainapps.multitype.ZrbhqViewBinder;
import com.skyline.terraexplorer.mainapps.multitype.Zrbhqjd;
...
public class ZrbhqListActivity extends BaseActivity {
    private static final String TAG = ZrbhqListActivity.class.getSimpleName();
    ...
    private List<Zrbhqjd> firejdList;
    private List<Zrbhqjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/supervisionAndInspectionOfNatureReserves/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Zrbhqjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(ZrbhqListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/supervisionAndInspectionOfNatureReserves/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Zrbhqjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(ZrbhqListActivity.this, AddzrbhqActivity.class);
...
*/
    ...
    private void register() {
        ZrbhqViewBinder zrbhqViewBinder = new ZrbhqViewBinder();
        adapter.register(Zrbhqjd.class, zrbhqViewBinder);
