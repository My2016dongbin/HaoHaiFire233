 ...
 */
public class LmcfViewBinder extends ItemViewBinder<lmcfjd, LmcfViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull lmcfjd lmcfjd) {
        holder.textView1.setText("地区: " + lmcfjd.getRegion() );
        holder.textView2.setText("检查人: " + lmcfjd.getSignatureMonitor() );
        holder.textView3.setText("负责人: " + lmcfjd.getHead() );
        holder.textView4.setText("电话: " + lmcfjd.getPhone() );
        holder.textView5.setText("采伐林木单位或个人: " + lmcfjd.getSignatureForestUnits() );
        holder.textView6.setText("地址: " + lmcfjd.getAddress() );
        String jcTime = lmcfjd.getInspectionTime()==null ? "" : lmcfjd.getInspectionTime();
