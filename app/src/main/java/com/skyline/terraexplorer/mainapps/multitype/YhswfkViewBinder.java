 ...
 */
public class YhswfkViewBinder extends ItemViewBinder<Yhswfkjd, YhswfkViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Yhswfkjd yhswfkjd) {
        holder.textView1.setText("地区: " + yhswfkjd.getRegion() );
        holder.textView2.setText("检查员: " + yhswfkjd.getSignatureOfInspector() );
        holder.textView3.setText("负责人: " + yhswfkjd.getHead() );
        holder.textView4.setText("被检查人: " + yhswfkjd.getSignatureOfDirector() );
        String jcTime = yhswfkjd.getInspectionTime()==null ? "" : yhswfkjd.getInspectionTime();
        holder.textView5.setText("检查时间: " + jcTime);
