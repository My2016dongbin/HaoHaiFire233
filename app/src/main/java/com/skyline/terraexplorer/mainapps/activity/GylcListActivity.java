...
import com.skyline.terraexplorer.mainapps.multitype.GylcViewBinder;
...
public class GylcListActivity extends BaseActivity {
    private static final String TAG = GylcListActivity.class.getSimpleName();
    ...
    private List<Gylcjd> firejdList;
    private List<Gylcjd> firejdTypeList;
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/supervisionAndInspectionOfStateOwnedForestFarms/page");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(dataList), new TypeToken<List<Gylcjd>>() {
                        }.getType());
                        ...
                        Toast.makeText(GylcListActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void selectDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "/forestry/api/supervisionAndInspectionOfStateOwnedForestFarms/list");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject1.getString("code").equals("200")) {
                        ...
                        firejdList = gson.fromJson(String.valueOf(data), new TypeToken<List<Gylcjd>>() {
                        }.getType());
                        firejdTypeList.addAll(firejdList);
                        if (isShuaxin){
                            swipeRefreshLayout.setRefreshing(false);
                ...
                switch ((var1)) {
                    ...
                    case -3:
                      //  showLeibieChangeDailog();
                        Intent intent=new Intent(GylcListActivity.this, AddgylcActivity.class);
...
*/
    ...
    private void register() {
        GylcViewBinder gylcViewBinder = new GylcViewBinder();
        adapter.register(Gylcjd.class, gylcViewBinder);
