 ...
 */
public class BsysViewBinder extends ItemViewBinder<Bsysjd, BsysViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Bsysjd bsysjd) {
        holder.textView1.setText("运输人: " + bsysjd.getCarrier() );
        holder.textView2.setText("车辆牌照: " + bsysjd.getLicencePlate() );
        String jcTime = bsysjd.getTransportStartTime()==null ? "" : bsysjd.getTransportStartTime();
        holder.textView3.setText("分节时间: " + jcTime);
        holder.textView4.setText("运输起点: " + bsysjd.getOrigin() );
        holder.textView5.setText("运输终点: " + bsysjd.getTerminus() );
        holder.textView6.setText("备注: " + bsysjd.getRemark());
        ...
        RxViewAction.clickNoDouble(holder.orderLayout)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        Log.e("TAG", "call: "+bsysjd.getId() );
                        listener.onBsxxItemClickListener(bsysjd.getId());
                    }
                });
    }
