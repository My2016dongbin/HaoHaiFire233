...
//    private TextView gugeGaochengText;
    ...
    private SwipeRefreshLayout sw_onebody;
...
//                        gugeGaochengText.setTextColor(getResources().getColor(R.color.c7));
    ...
    private void initView() {
        ...
        sw_onebody = ((SwipeRefreshLayout) onebodyListInflater.findViewById(R.id.sw_onebody));
        ...
        //下拉刷新
        sw_onebody.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                sw_onebody.setRefreshing(false);
                getonebodyDataFromSetvice();
            }
        });
        //加载更多
