package com.skyline.ledge.videolibrary.video.base;
...
import com.skyline.ledge.videolibrary.R;
import com.skyline.ledge.videolibrary.listener.GSYMediaPlayerListener;
import com.skyline.ledge.videolibrary.listener.VideoAllCallBack;
import com.skyline.ledge.videolibrary.utils.CommonUtil;
import com.skyline.ledge.videolibrary.utils.Debuger;
import com.skyline.ledge.videolibrary.utils.NetInfoModule;

import java.io.File;
import java.util.HashMap;
import java.util.Map;

import static com.skyline.ledge.videolibrary.utils.CommonUtil.getTextSpeed;
...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    private static final String TAG = GSYVideoView.class.getSimpleName();
    ...
    //视频播放格式出现错误 是否继续播放  true 播放
    protected boolean mVideoTypeErrorIsPlay = false;
        ...
        public void onAudioFocusChange(int focusChange) {
            switch (focusChange) {
                ...
                case AudioManager.AUDIOFOCUS_LOSS:
                    Log.e(TAG, "onAudioFocusChange: 失去焦点" );
                    onLossAudio();
                    break;
            ...
            public void run() {
                if (GSYVideoView.this.mReleaseWhenLossAudio) {
                  ...
                  //  GSYVideoView.this.onVideoPause();
                    GSYVideoView.this.onVideoResume();      //回复暂停状态
                 //   GSYVideoView.this.startPrepare();      //回复暂停状态
                }
    ...
    protected void onLossTransientAudio() {
        Log.e(TAG, "onLossTransientAudio: 暂时失去Audio Focus，并会很快再次获得" );
        try {
            this.onVideoPause();
    ...
    protected void onLossTransientCanDuck() {
        Log.e(TAG, "onLossTransientCanDuck: 暂时失去AudioFocus，但是可以继续播放，不过要在降低音量" );
    }
    ...
    protected void deleteCacheFileWhenError() {
        Log.e(TAG, "deleteCacheFileWhenError: ");
        clearCurrentCache();
     ...
     * 视频播放格式出现错误，是否重新播放
     */
    public void setVideoTypeErrorIsPlayer(boolean isPlayer) {
        this.mVideoTypeErrorIsPlay = isPlayer;
    }
