...
public class MyFragment extends HhBaseFragment {
    ...
    private void initView() {
        ...
        baojingSwich.setChecked(user.getIsyunyin()==1);
        ...
        RxViewAction.clickNoDouble(outButtonView)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        XGPushManager.cleanTags(getContext(),new DbConfig(getContext()).getUser().getId());
                        XGPushManager.cleanTags(getContext(),new DbConfig(getContext()).getUser().getGridNo());
                        XGPushManager.cleanTags(getContext(),new DbConfig(getContext()).getUser().getGroupId());
                        DbConfig dbConfig = new DbConfig(getContext());
